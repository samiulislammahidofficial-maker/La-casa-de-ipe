...
export default function TicketView({ eventId, onViewChange }: TicketViewProps) {
  ...
  useEffect(() => {
    const EVENTS: Record<number, string> = {
      2: "La Casa del Emprendedor (BIZZ)",
      3: "Integration Bee",
      4: "Tug of War",
      5: "The Bizz Seminar",
      6: "La Guerra De Argumentos",
      7: "Chess",
      8: "FIFA",
      9: "Pes",
      10: "Football",
      11: "Uno",
      12: "El Codigo 29",
      13: "Las Reinas De la Casa (Ludo, Musical Chair, Pillow Passing)",
      19: "Table Tennis",
      20: "Theme Game",
      21: "Guess The Movies or song",
      24: "La Casa del Teclado",
      25: "Frames De Bella Ciao",
      26: "Meme Comp",
      27: "Los Artistas Al Mando",
      28: "La Noche Del Atraco",
      999: "La Caza de Tesoro",
    };
