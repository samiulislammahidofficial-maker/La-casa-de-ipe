  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      if (err.code === "auth/popup-closed-by-user") {
        ...
        setGlobalError(
          "Google Sign-In is not allowed from this domain. Please add the current domain to your Firebase Console -> Authentication -> Settings -> Authorized Domains."
        );
      } else {
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        <div className="bg-[#111]/90 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-[0_0_60px_rgba(0,0,0,0.8)]">
          ...
          {/* Google Sign-In Option for Sign Up */}
          {!firebaseUser ? (
            <>
              <button
                type="button"
            ...
            <div className="mb-6 p-4 bg-green-500/10 border border-green-500/30 rounded-xl flex items-center justify-between">
              <div>
                ...
                <p className="font-mono text-xs text-white mt-0.5 truncate max-w-[240px]">
                  {firebaseUser.email}
                </p>
              </div>
              <button
                ...
                className="font-mono text-[10px] text-gray-400 hover:text-white underline cursor-pointer"
              >
                Change
              </button>
            </div>
